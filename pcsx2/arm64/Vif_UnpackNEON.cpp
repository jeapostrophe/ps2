...
// Code region for the 256 simple unpack kernels (measured ~30KB; 128KB gives
// slack). RWX like the other lrps2 arm64 code caches.
static u8* s_upkCode = nullptr;
static constexpr size_t kUpkCodeSize = 128 * 1024;
